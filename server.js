...
//routes
var web_student = require('./routes/web_student/web_student.js')
var web_shop = require('./routes/web_shop/web_shop.js')
var web_subscribe = require('./routes/web_subscribe/web_subscribe.js')
var rending = require('./routes/rending/rending.js')
var nckufood_subscribe = require('./routes/nckufood_subscribe/nckufood_subscribe.js')
var nckufood_shop = require('./routes/nckufood_shop/nckufood_shop.js')
var nckufood_student = require('./routes/nckufood_student/nckufood_student.js')
var webhook = require('./routes/webhook/webhook.js')

app.use('/',web_student)
app.use('/',web_shop)
app.use('/',web_subscribe)
app.use('/',rending)
app.use('/',nckufood_subscribe)
app.use('/',nckufood_shop)
app.use('/',nckufood_student)
app.use('/',webhook)
